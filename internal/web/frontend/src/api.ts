...
// Worker-status vocabulary — the terminal/steerable/slot status sets and the
// predicates over them — lives in lib/workerStatus.ts, not here: this module is
// the transport layer, and no request or response shape depends on those
// readings. Import them from '../lib/workerStatus'.
