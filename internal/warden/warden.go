...
//
// The parser splits on "diff --git " header boundaries; each file's block
// runs from its header up to the next header. When patterns is empty or the
// input contains no "diff --git" headers, the diff is returned unchanged.
