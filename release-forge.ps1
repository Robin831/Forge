...
function Generate-ReleaseNotes {
    ...
    [void]$sb.AppendLine('```')
    [void]$sb.AppendLine("")
    [void]$sb.AppendLine("**macOS (Homebrew):**")
    [void]$sb.AppendLine('```bash')
    [void]$sb.AppendLine('brew install Robin831/forge/forge')
    [void]$sb.AppendLine('```')
    [void]$sb.AppendLine("")
    [void]$sb.AppendLine("**Windows (PowerShell):**")
    [void]$sb.AppendLine('```powershell')
    [void]$sb.AppendLine('irm https://raw.githubusercontent.com/Robin831/Forge/main/install.ps1 | iex')
    [void]$sb.AppendLine('```')
    [void]$sb.AppendLine("")
    [void]$sb.AppendLine("**Windows (Scoop):**")
    [void]$sb.AppendLine('```')
    [void]$sb.AppendLine('scoop bucket add forge https://github.com/Robin831/scoop-forge')
    [void]$sb.AppendLine('scoop install forge')
    [void]$sb.AppendLine('```')
    [void]$sb.AppendLine("")
